...
const Privacy = () => {
  return (
    <Container maxWidth="lg" style={{ padding: "35px" }}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to DistroAve, 8638 ROVANA
            CIR SACRAMENTO, CA 95828.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to DistroAve, accessible from:{" "}
            <a
              href="https://distro-ave.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://distro-ave.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>Age (whether or not You are over 21 years)</p>
        </li>
        <li>
          <p>
            The existance of Your medical license to purchase cannabis (if
            appplicable)
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: info@distro-ave.com</p>
        </li>
        <li>
          <p>By phone number: (916) 293-1253</p>
        </li>
      </ul>
    </Container>
  );
